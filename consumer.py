...
def parse_args():
    ...
    parser.add_argument("--broker", type=str, default=os.environ.get("MQTT_BROKER", "localhost"))    parser.add_argument("--port",   type=int, default=int(os.environ.get("MQTT_PORT", 1883)))
